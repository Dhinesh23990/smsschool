(function (angular, factory) {
    ...
    function ($templateCache) {
		...
		$templateCache.put('ng-table/filters/text.html', '<input type="text" name="{{column.filterName}}" ng-model="params.filter()[name]" ng-keypress="doTextSubmit($event)" ng-if="filter==\'text\'" class="input-filter form-control"/>');
		...
		$templateCache.put('ng-table/filters/number.html','<div class="form-inline" ng-init="optionsValName = name+\'_options\'; startValName = name+\'_start\'; endValName = name+\'_end\'; showStartVal = false;">'+
			   '<input class="input-filter form-control pull-left" style="background-color:#fff;width:50px;float:left;" type="text" ng-model="params.filter()[startValName]" ng-show="showStartVal" />'+
			   ...
			   '<input class="input-filter form-control pull-left" style="width:50px;float:left;" type="text" ng-model="params.filter()[endValName]" />'+
