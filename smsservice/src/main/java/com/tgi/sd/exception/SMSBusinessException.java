...
public class SMSBusinessException extends Throwable {
	...
	public SMSBusinessException(final String msg) {
		super(msg);
		this.errorConstant = msg;
	}
	
	public SMSBusinessException(final String msg, final Throwable cause) {
		super(msg, cause);
		this.errorConstant = msg;
	...
	public SMSBusinessException(final Throwable cause) {
		super("", cause);
